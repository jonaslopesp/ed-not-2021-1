...
class FormaGeometrica {
    ...
    constructor(base, altura, tipo){
        ...
        // em alguma lugar, de modo que, ao sair do constructor(), essas informações não
        // se percam.
   ...
   /*
        setters: permitem que o mundo externo possa alterar o valor de atributos
        privados, caso o novo valor esteja de acordo com as regras de negócio.
   */
...
try { // TENTA executar as linhas contidas
    // Se acontecer alguma exceção no bloco try, a execução é desviada para o bloco cath
...
//forma1.base = 'khkhkj'  // Não funcionar

console.log('calcularArea() de forma 1 (método):', forma1.calcularArea())
